...
export class Catalogo {
  ...
  inicializarProductos() {
    ...
    this.productos.push(
      new Producto(
        1,
        "Camiseta Shadow Pulse",
        "Camiseta negra de algodón premium con diseño cyber sigilism",
        45.000,
      ...
      new Producto(
        3,
        "Camiseta Ghost Vision",
        "Camiseta gris vintage con acabado suave y diseño nostálgico",
        55.900,
      ...
      new Producto(
        4,
        "Camiseta Abyss Script",
        "Camibuzo gris con negro con tipografía bold y estilo grunge contemporáneo",
        32.00,
      ...
      new Producto(
        5,
        "Camiseta Inferno Drop",
        "Camiseta oversize con detalles flame y toque retro streetwear",
        32.00,
